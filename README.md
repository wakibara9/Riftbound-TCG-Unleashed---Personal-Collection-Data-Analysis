...
| **Overnumbered Signature** | 1:360 packs | 0.06 per box *(~1 hit every 15 boxes)* |
...
* **Technical Success:** Replacing traditional, scale-limiting charts with a side-by-side horizontal asset layout solved the high-cardinality problem. It preserved the visibility of micro-adjustments in rare $0.6\%$ tiers while cleanly handling the massive $50\%$ baseline categories on a single, readable axis.
